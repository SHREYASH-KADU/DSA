...
public class QuickSort {
    ...
    static void sort(int[]arr, int low, int high)
    {
        ...
        int start = low;
        int end = high;
        int pivot = arr[(start+end)/2];//pivot will be adjacent element
        //note : you can take any pivot

        // This Loop will shift elements < pivot at left side of the pivot..
        // And element > pivot will be shifted to right side of the pivot..
        while(start<=end)
        {
