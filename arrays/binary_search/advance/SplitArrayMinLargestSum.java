...
public class SplitArrayMinLargestSum {
    ...
    static int findSplitArrayMinLargestSum(int [] arr , int M) 
    {
        ...
        while(s<=e)
        {
            ...
            if(allocationIsPossible(arr,M,mid)) 
            {
    ...
    private static boolean allocationIsPossible(int [] arr , int M , int mid)
    {
